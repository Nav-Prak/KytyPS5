...
The working source commit is the exact code snapshot that was used for the successful gameplay test. The compatibility document and generated-artifact ignore rules are recorded separately so that the source hash remains unambiguous.
