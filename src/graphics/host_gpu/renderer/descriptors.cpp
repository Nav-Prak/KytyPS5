...
ResolveTargetTextureViewForBinding(const ShaderRecompiler::IR::ImageResource& resource,
                                   Prospero::ImageType type, bool storage, uint32_t height,
                                   uint32_t base_layer, uint32_t image_layers) {
	if (type == Prospero::ImageType::kColor1D || type == Prospero::ImageType::kColor2D) {
