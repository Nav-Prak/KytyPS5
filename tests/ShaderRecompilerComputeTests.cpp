...
public:
  ...
  void CheckMutableStorageR8View() {
    ...
    view_info.image = image;
    view_info.viewType = vk::ImageViewType::e2D;
    view_info.format = vk::Format::eR8Uint;
    view_info.subresourceRange.aspectMask = vk::ImageAspectFlagBits::eColor;
    view_info.subresourceRange.levelCount = 1;
    view_info.subresourceRange.layerCount = 1;
    ...
    view_usage.usage = vk::ImageUsageFlagBits::eSampled;
    view_info.format = vk::Format::eR8Unorm;
    view_info.components = {vk::ComponentSwizzle::eR, vk::ComponentSwizzle::eR,
                            vk::ComponentSwizzle::eR, vk::ComponentSwizzle::eOne};
    vk::ImageView sampled_view = nullptr;
    RequireVk(name, "sampled view",
              m_device.createImageView(&view_info, nullptr, &sampled_view),
              "vkCreateImageView(R8_UNORM sampled)");

    m_device.destroyImageView(sampled_view, nullptr);
...
private:
  ...
  void Init() {
    ...
    vk::PhysicalDeviceVulkan12Features available_vulkan12{};
    available_vulkan12.sType = vk::StructureType::ePhysicalDeviceVulkan12Features;
    ...
    Require("VulkanHarness", "dispatch",
            available_vulkan12.shaderBufferInt64Atomics == true,
    ...
    vk::PhysicalDeviceVulkan12Features device_vulkan12{};
    device_vulkan12.sType = vk::StructureType::ePhysicalDeviceVulkan12Features;
    device_vulkan12.shaderBufferInt64Atomics = true;
...
TestCase ImageSampleBc7PreservesTransparentAlpha() {
  ...
  test.sampled_image_rgba = image;
  test.sampled_image_format = vk::Format::eBc7UnormBlock;
  test.sampled_image_dwords_per_pixel = 1;
  return test;
}
...
void CheckStorageTextureSampledReuse() {
  ...
  Require("StorageTextureSampledReuse", "R8 UINT-to-UNORM sampled view",
          IsMutableStorageSampledViewFormat(vk::Format::eR8Uint) &&
              IsCompatibleStorageSampledViewFormat(vk::Format::eR8Uint,
                                                   vk::Format::eR8Unorm) &&
              ClassifyStorageSampledOverlap(
                  r8_unorm_sampled, r8_uint_storage, vk::Format::eR8Unorm,
                  vk::Format::eR8Uint, true, false,
                  true) == StorageSampledOverlap::ExactImage,
